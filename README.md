...
```bash
cd /home/kali/Desktop/ChatRoom/mato
./install.sh
```
...
![desk分区功能](D:\Storage\Photo\mato\desk分区功能.gif)
...
![alarm功能](D:\Storage\Photo\mato\alarm功能.gif)

管理100个codex的你也想知道谁干完活了吧！干完了吱一声继续抽你

### Terminal Presets

![前置脚本功能](D:\Storage\Photo\mato\前置脚本功能.gif)
